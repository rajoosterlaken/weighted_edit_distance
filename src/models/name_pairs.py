...
class NamePair(object):
    def __init__(self, pair_id, variant1, variant2, n_paar, n_pvoorkomen1, n_pvoorkomen2, n_genlias1, n_genlias2, n_namen):
        self.pair_id = pair_id
        self.variant1 = variant1
        self.variant2 = variant2
        self.variant1 = unidecode(variant1)
        self.altered_variant1 = variant1 != self.variant1
        self.variant2 = unidecode(variant2)
        self.altered_variant2 = variant2 != self.variant2
...
class FirstNamePair(NamePair):
    def __init__(self, vpv_id, sexe, variant1, variant2, n_paar, n_pvoorkomen1, n_pvoorkomen2, n_genlias1, n_genlias2, n_namen, grondnaam1, grondnaam2, *args):
...
class LastNamePair(NamePair):
    def __init__(self, vpf_id, variant1, variant2, n_paar, n_pvoorkomen1, n_pvoorkomen2, n_genlias1, n_genlias2, n_namen, *args):
